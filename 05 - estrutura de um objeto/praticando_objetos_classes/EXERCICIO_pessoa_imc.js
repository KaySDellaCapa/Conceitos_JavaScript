...
const gi = new Pessoa ('Giovanna', 49, 1.70);
const kay = new Pessoa ('Kayque', 76, 1.66);

console.log('---------------')
console.log(jose, gi, kay);
...
console.log('---------------')
console.log(kay.calcularImc().toFixed(2));
console.log(kay.classificarImc());
console.log('---------------')
